-- Users > member detail: learning overview read RPC.
-- Owner decision (2026-06-18): expose operational learning aggregates and recent
-- problem-solving history only; do not expose writing answer text or sentence feedback.
-- Reads v13-owned learning/payment-adjacent tables without FK/DDL/table creation.
-- down: supabase/migrations-admin/down/20260618120000_admin_user_learning_overview.sql

create or replace function public.get_admin_user_learning_overview(
  target_id uuid
)
returns table (
  kpis jsonb,
