-- Down for 20260709150000_admin_users_phone_and_export.sql
-- admin_export_users / private.mask_phone 를 제거하고, get_admin_users(5인자)와
-- get_admin_user 를 phone/gender 보강 이전 정의(20260626120000/20260707120000 결과 상태)로 되돌린다.
-- 참고: 4인자 get_admin_users 레거시 오버로드는 20260623120000 에서 폐기된 dev 드리프트
-- 잔존분이었으므로 down 에서도 재생성하지 않는다.
