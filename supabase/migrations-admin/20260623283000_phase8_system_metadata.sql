-- Phase 8 enforcement (system metadata): admin_has_permission gates after is_admin.
-- Generated from live bodies by scripts/db/gen-phase8-enforcement.mjs.
-- down: supabase/migrations-admin/down/20260623283000_phase8_system_metadata.sql
...
begin
  ...
  if not public.admin_has_permission(caller_id, 'system.metadata.manage') then raise exception 'forbidden: missing permission system.metadata.manage'; end if;
