...
| --- | --- | --- | --- | --- |
| 2026-03-13 | `Users > 회원 목록 / Users > 회원 상세 / Users > 추천인 관리 / Users > 강사 관리 / Community > 게시글 관리 / Community > 신고 관리 / Commerce > 결제 내역 / Commerce > 환불 관리 / Message > 발송 이력` | 사용자 표시 규칙 통합 | `docs/specs/page-ia/users-list-page-ia.md`, `docs/specs/page-ia/users-detail-page-ia.md`, `docs/specs/page-ia/users-referrals-page-ia.md`, `docs/specs/page-ia/users-instructor-management-page-ia.md`, `docs/specs/page-ia/community-posts-page-ia.md`, `docs/specs/page-ia/community-reports-page-ia.md`, `docs/specs/page-ia/commerce-payments-page-ia.md`, `docs/specs/page-ia/commerce-refunds-page-ia.md`, `docs/specs/page-ia/message-history-page-ia.md`, `docs/specs/admin-page-tables.md`, `docs/guidelines/admin-ux-ui-design.md` | 테이블의 사용자 참조 셀을 raw ID 단독 노출에서 `이름 (ID)` 링크 기준으로 통일하고, 상세 영역의 사용자명 필드도 같은 형식으로 유지하는 규칙을 공통 문서와 페이지별 IA에 반영 |
