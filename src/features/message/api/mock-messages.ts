...
const initialTemplates: MessageTemplate[] = [
  ...
  },
  {
    ...
    category: '커뮤니티',
    name: '댓글 답변 알림',
    summary: '내 게시글에 댓글이 달리면 인앱 알림을 보냅니다.',
    subject: '새 댓글이 도착했습니다',
    targetGroupIds: ['GRP-001'],
    status: '활성',
    triggerLabel: '새 댓글 등록 직후',
    bodyHtml: '<p>회원님의 게시글에 새 댓글이 달렸습니다. 지금 확인해 보세요.</p>',
    bodyJson: createBodyJson('회원님의 게시글에 새 댓글이 달렸습니다. 지금 확인해 보세요.'),
    // 알림 클릭 시 이동할 앱 내부 경로.
  ...
  },
  {
    ...
    category: '결제',
    name: '결제 완료 알림',
    summary: '정기 결제가 완료되면 영수증 화면으로 이동하는 인앱 알림입니다.',
    subject: '결제가 완료되었습니다',
    targetGroupIds: ['GRP-001'],
    status: '활성',
    triggerLabel: '결제 성공 직후',
    bodyHtml: '<p>정기 결제가 정상 처리되었습니다. 영수증을 확인해 보세요.</p>',
    bodyJson: createBodyJson('정기 결제가 정상 처리되었습니다. 영수증을 확인해 보세요.'),
    linkUrl: '/my/payments',
    lastSentAt: '2026-03-09 19:05',
    updatedAt: '2026-03-08 10:25',
    updatedBy: 'admin_park'
  },
  {
    ...
    category: '운영',
    name: '신규 공지 알림',
    summary: '새 공지가 등록되면 공지 상세로 이동하는 수동 인앱 알림입니다.',
    subject: '새로운 공지사항이 등록되었습니다',
    targetGroupIds: ['GRP-004'],
    status: '활성',
    bodyHtml: '<p>새로운 공지사항이 등록되었습니다. 자세한 내용을 확인해 주세요.</p>',
    bodyJson: createBodyJson('새로운 공지사항이 등록되었습니다. 자세한 내용을 확인해 주세요.'),
    linkUrl: '/notice',
    lastSentAt: '2026-03-07 10:10',
    updatedAt: '2026-03-09 08:20',
    updatedBy: 'admin_lee'
  }
];
