...
const statusDescriptionMap: Record<string, string> = {
  ...
  '검수 대기': 'AI 생성 이후 아직 운영자가 검수하지 않은 상태입니다.',
  '검수 중': '운영자가 현재 내용을 확인하며 검수 판단을 진행 중인 상태입니다.',
  보류: '추가 확인이나 정책 판단이 필요해 즉시 확정하지 않은 상태입니다.',
  '검수 완료': '검수 기준을 통과해 운영 상태 관리 단계로 넘길 수 있는 상태입니다.',
  '수정 필요': '재생성 또는 수동 수정이 필요하다고 판단한 상태입니다.',
  '노출 후보': '검수는 통과했으며 이후 노출 대상으로 우선 검토하는 상태입니다.',
  '숨김 후보': '품질은 허용되지만 우선순위가 낮아 숨김 대상으로 관리하는 상태입니다.',
  '운영 제외': '현재 운영 대상에서는 제외하기로 결정한 상태입니다.'
};
