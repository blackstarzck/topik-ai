...
- **커밋 전 게이트**:
  - `npm run harness:check` (mojibake · doc-crosslinks · route-doc-coverage · message-history-boundary · router-state-notice-boundary · duplication(jscpd 임계) · lint(max-lines·mock 경계 포함) · typecheck)
